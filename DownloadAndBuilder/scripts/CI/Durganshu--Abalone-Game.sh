...
SOURCE_FILE="$REPO_DIR/search-alphabeta.cpp"
OUTPUT_FILE="$REPO_DIR/search-alphabeta"
...
SOURCE_FILE="$REPO_DIR/search-abid-parallel.cpp"
OUTPUT_FILE="$REPO_DIR/search-abid-parallel"
