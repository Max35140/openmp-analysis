...
SOURCE_FILE="$REPO_DIR/kakuro_solver.cpp"
OUTPUT_FILE="$REPO_DIR/kakuro_solver"
...
SOURCE_FILE="$REPO_DIR/kakuro_solver_omp.cpp"
OUTPUT_FILE="$REPO_DIR/kakuro_solver_omp"
