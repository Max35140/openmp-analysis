...
SOURCE_FILE="$REPO_DIR/supplementary.c"
OUTPUT_FILE="$REPO_DIR/supplementary"
...
gcc -o "$OUTPUT_FILE" "$SOURCE_FILE" -fopenmp -I$REPO_DIR/
echo "Erfolgreich kompiliert: $OUTPUT_FILE"

SOURCE_FILE="$REPO_DIR/VPT.c"
OUTPUT_FILE="$REPO_DIR/VPT"
