...
SOURCE_FILE="$REPO_DIR/Parallel_2/Strassen.cpp"
...
SOURCE_FILE="$REPO_DIR/Parallel_2/fft/fft.cpp"
...
SOURCE_FILE="$REPO_DIR/Parallel_2/Sudoku/Sudoku.cpp"
OUTPUT_FILE="$REPO_DIR/Sudoku"
