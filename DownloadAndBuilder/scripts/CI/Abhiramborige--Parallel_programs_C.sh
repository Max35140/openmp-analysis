...
SOURCE_FILE="$REPO_DIR/LabFAT/que1.c"
OUTPUT_FILE="$REPO_DIR/que1"
...
SOURCE_FILE="$REPO_DIR/Assignment2/fibonacci.c"
OUTPUT_FILE="$REPO_DIR/fibonacci"
...
SOURCE_FILE="$REPO_DIR/Assignment2/mergesort.c"
OUTPUT_FILE="$REPO_DIR/mergesort"
