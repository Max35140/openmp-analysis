...
SOURCE_FILE="$REPO_DIR/task4_gameoflife/gameoflife_task_omp/gameoflife.c"
OUTPUT_FILE="$REPO_DIR/gameoflife1"
...
SOURCE_FILE="$REPO_DIR/task5_hotspot/hotspot_omp_single_threadpool/hotspot.c"
OUTPUT_FILE="$REPO_DIR/hotspot"
