...
SOURCE_FILE="$REPO_DIR/solvers/openmp_solver.cpp"
OUTPUT_FILE="$REPO_DIR/openmp_solver"
...
g++ -o "$OUTPUT_FILE" "$SOURCE_FILE" -fopenmp -I/home/max/Downloads/openmp-analysis2/DownloadAndBuilder/data/MekhyW--Vehicle-routing-optimization/include
