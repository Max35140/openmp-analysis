...
SOURCE_FILE="$REPO_DIR/fibonacci_OpenMP/fibonacci_par1.c"
OUTPUT_FILE="$REPO_DIR/fibonacci_par1"
...
SOURCE_FILE="$REPO_DIR/fibonacci_OpenMP/fibonacci_par2.c"
OUTPUT_FILE="$REPO_DIR/fibonacci_par2"
...
SOURCE_FILE="$REPO_DIR/fibonacci_OpenMP/fibonacci_par3.c"
OUTPUT_FILE="$REPO_DIR/fibonacci_par3"
