...
g++ -o "$OUTPUT_FILE" "$SOURCE_FILE" -fopenmp -I$REPO_DIR/00_graph_bench/include/preprocess -I$REPO_DIR/00_graph_bench/include/config -I$REPO_DIR/00_graph_bench/include/utils -I$REPO_DIR/00_graph_bench/include/algorithms/openmp -I$REPO_DIR/00_graph_bench/include/structures
