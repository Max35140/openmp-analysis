...
SOURCE_FILE="$REPO_DIR/TreeSearch/TreeSearch/LinearSearchcpp.cpp"
OUTPUT_FILE="$REPO_DIR/LinearSearchcpp"
...
g++ -o "$OUTPUT_FILE" "$SOURCE_FILE" -fopenmp -I$REPO_DIR/TreeSearch/TreeSearch
