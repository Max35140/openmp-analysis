...
SOURCE_FILE="$REPO_DIR/mergeP.c"
OUTPUT_FILE="$REPO_DIR/mergeP"
...
SOURCE_FILE="$REPO_DIR/mergeSortPv2_omp.c"
OUTPUT_FILE="$REPO_DIR/mergeSortPv2_omp"
...
SOURCE_FILE="$REPO_DIR/mergeSortPv1_omp.c"
OUTPUT_FILE="$REPO_DIR/mergeSortPv1_omp"
