...
SOURCE_FILE="$REPO_DIR/Exercise-1/Ex2/gaussian-blur.c"
OUTPUT_FILE="$REPO_DIR/gaussian-blur"
...
SOURCE_FILE="$REPO_DIR/Exercise-1/Ex3/matmul.c"
OUTPUT_FILE="$REPO_DIR/matmul"
...
SOURCE_FILE="$REPO_DIR/Exercise-1/Ex3/dotproduct.c"
OUTPUT_FILE="$REPO_DIR/dotproduct"
