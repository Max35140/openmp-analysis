...
# Include-Pfad für die Header-Datei SudokuSolver_ParallelBruteForce.hpp
INCLUDE_DIR="$REPO_DIR/inc"

SOURCE_FILE="$REPO_DIR/src/SudokuSolver_ParallelBruteForce.cpp"
OUTPUT_FILE="$REPO_DIR/SudokuSolver_ParallelBruteForce"
